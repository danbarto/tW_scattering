...
if __name__ == '__main__':
    ...
    #df = pd.read_hdf('../processor/multiclass_input_2018_trilep_v2.h5')
    ...
    df_in = pd.concat([df_signal, df_prompt, df_resonant, df_NP, df_XG])
    ...
    hist_labels = ['top-W', 'nonresonant', 'resonant', 'NP', 'XG']

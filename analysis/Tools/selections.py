...
from analysis.Tools.triggers import getTriggers, getFilters
from analysis.Tools.objects import choose, cross, choose3
...
class Selection:
    ...
    def dilep_baseline(self, omit=[], add=[], only=[], cutflow=None, tight=False, SS=True, DY=False, Zsel='none'):
        ...
        self.selection.add('invMET',        (self.met.pt<30) )

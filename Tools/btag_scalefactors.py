    ...
    def __init__(self, year, era=None, UL=True):
        ...
        if self.year == 2016:
            if era=='APV':
                ...
                self.ext.add_weight_sets([os.path.expandvars(f"* * $TWHOME/data/btag/deepJet_eff_Summer20UL16APV.json")])
                ...
                # and load the efficiencies
                self.ext.add_weight_sets([os.path.expandvars(f"* * $TWHOME/data/btag/deepJet_eff_Summer20UL16.json")])
            ...
            # and load the efficiencies
            self.ext.add_weight_sets([os.path.expandvars(f"* * $TWHOME/data/btag/deepJet_eff_Summer20UL17.json")])
            ...
            # and load the efficiencies
            self.ext.add_weight_sets([os.path.expandvars(f"* * $TWHOME/data/btag/deepJet_eff_Summer20UL18.json")])

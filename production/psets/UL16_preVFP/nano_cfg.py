...
# with command line options: --filein file:miniAOD.root --fileout file:nanoAOD.root --mc --eventcontent NANOAODSIM --datatier NANOAODSIM --conditions 106X_mcRun2_asymptotic_preVFP_v9 --step NANO --era Run2_2016_HIPM --python_filename nano_cfg.py -n 10 --no_exec

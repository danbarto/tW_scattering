...
# with command line options: step3 --filein input.root --fileout file:nanoAOD.root --step NANO --era Run3 --customise=PhysicsTools/NanoAOD/V10/nano_cff.nanoAOD_customizeV10 --eventcontent NANOAODSIM --datatier NANOAODSIM --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=100 --nThreads 8 --python_filename nanov10_cfg.py -n -1 --no_exec --conditions 122X_mcRun3_2021_realistic_v9 --mc

...
# with command line options: step3 --filein file:output_maod.root --fileout file:output_nano.root --mc --eventcontent NANOAODSIM --datatier NANOAODSIM --conditions 106X_upgrade2018_realistic_v15_L1v1 --step NANO --nThreads 8 --era Run2_2018 --python_filename nano_cfg.py -n 10 --no_exec

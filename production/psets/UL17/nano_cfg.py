...
# with command line options: --python_filename nano_cfg.py --filein file:miniAOD.root --fileout file:nanoAOD.root --mc --eventcontent NANOAODSIM --datatier NANOAODSIM --conditions 106X_mc2017_realistic_v8 --step NANO --era Run2_2017 -n 10 --no_exec

...
# with command line options: --python_filename NanoAODv7_cfg.py --eventcontent NANOAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --fileout file:nanoAOD.root --conditions 102X_upgrade2018_realistic_v21 --step NANO --filein miniAOD.root --era Run2_2018,run2_nanoAOD_102Xv1 --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False))) --no_exec --mc
